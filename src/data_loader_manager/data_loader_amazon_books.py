...
data_loader_movies.py:  
    ...
    Loads AmazonBooks dataset from data
"""
...
class DataLoaderAmazonBooks(DataLoaderWrapper):
    '''
    Data loader migrated from KGIN official codes
    ...
    def set_dataloader(self):
        ...
        self.train_dataset = KGINDataset(self.config, train_dataset_dict)
        ...
        self.test_dataset = KGINDataset(self.config, test_dataset_dict)
...
class KGINDataset(torch.utils.data.Dataset):
